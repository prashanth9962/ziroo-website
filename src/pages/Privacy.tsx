    ...
    <div style={{ background: 'var(--bg)', color: 'var(--cream)', minHeight: '100vh', overflowY: 'auto' }}>
      ...
      <article className="legal-article" style={{ maxWidth: '720px', margin: '0 auto' }}>
        ...
        <Section title="2. Categories of personal data we collect">
          ...
          <Sub title="2.7 Usage and analytics data">
          ...
          <Sub title="2.8 Derived data (generated by our AI)">
        ...
        <Section title="5. Who we share your data with">
          <ul style={list}>
            ...
            <li><strong>AI API providers:</strong> Anthropic, Google (Gemini), and OpenAI (under zero-data-retention agreements).</li>
        ...
        <Section title="10. Cookies and tracking technologies">
          <ul style={list}>
            ...
            <li><strong>Analytics:</strong> First-party, privacy-preserving usage analytics only. Can be disabled via cookie banner.</li>
